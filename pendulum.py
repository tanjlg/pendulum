...
st.subheader('Procedure')
st.markdown("5. Calculate the average time for 20 oscillations, usng the formula $<t>=(t_1+t_2)/2$. Hence, calculate the period of the pendulum $T = <t>/20$ and $T^2$.")
t = (t1+t2) / 2
T = t / 20
T2 = T ** 2
df2 = df
...
st.write('Return yours answers to these questions, alongside screen captures of this page to your teacher.')
