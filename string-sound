...
The Streamlit app is intended to compliment an inquiry activity on the relationship of a string under tension with length.
"""
...
st.subheader('Aim')
st.write('To investigate the relationship between the frequency of the sound produced by a strung string and its length')
