...
length, t1, t2, tave, T, T2 = numpy.zeros(shape, dtype=float16), numpy.zeros(shape, dtype=float16), numpy.zeros(shape, dtype=float16), numpy.zeros(shape, dtype=float16), numpy.zeros(shape, dtype=float16), numpy.zeros(shape, dtype=float16)
