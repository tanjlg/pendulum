...
length, t1, t2, tave, T, T2 = numpy.zeros(8, dtype=numpy.half), numpy.zeros(8, dtype=numpy.half), numpy.zeros(8, dtype=numpy.half), numpy.zeros(8, dtype=numpy.half), numpy.zeros(8, dtype=numpy.half), numpy.zeros(8, numpy.half)
